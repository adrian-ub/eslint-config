...
export async function typescript(
  ...
  function makeParser(typeAware: boolean, files: string[], ignores?: string[]): TypedFlatConfigItem {
    return {
      ...
      name: `adrianub/typescript/${typeAware ? 'type-aware-parser' : 'parser'}`,
    }
  }
  ...
  return [
    {
      ...
      name: 'adrianub/typescript/setup',
      plugins: {
    ...
    {
      files,
      name: 'adrianub/typescript/rules',
      rules: {
        ...renameRules(
    ...
    ...isTypeAware
      ? [{
          ...
          name: 'adrianub/typescript/rules-type-aware',
          rules: {
            ...typeAwareRules,
            ...overridesTypeAware,
          },
