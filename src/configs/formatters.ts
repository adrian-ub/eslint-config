...
export async function formatters(
  ...
  if (options.markdown) {
    ...
    configs.push({
      ...
      name: 'adrianub/formatter/markdown',
      rules: {
        [`format/${formater}`]: [
          'error',
          formater === 'prettier'
  ...
  if (options.astro) {
    ...
    configs.push({
      ...
      name: 'adrianub/formatter/astro/disables',
      rules: {
  ...
  if (options.graphql) {
    configs.push({
      ...
      name: 'adrianub/formatter/graphql',
      rules: {
        'format/prettier': [
          'error',
          mergePrettierOptions(prettierOptions, {
