...
const isCwdInScope = isPackageExists('@adrianub/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@adrianub/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@adrianub/eslint-config'
